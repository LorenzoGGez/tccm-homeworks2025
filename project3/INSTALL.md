...
the necessary code in the src directory. This is the code used for molecular dynamic calculation.
...
After the installation the user will also get a test file, where the user will be able 
to understand how to set his own input data file, with
...
the moldyn.f90 program and the physics.f90 module with the following command: 
$  gfortran src/physics.f90 src/moldyn.f90 -o executable
