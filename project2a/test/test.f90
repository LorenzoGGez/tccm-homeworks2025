...
use sparse_mod
implicit none
integer :: ndim1, ndim2, i, j, n_mul, n, i_stat, option, option1
double precision :: y
...
! choosing the routine to use
111 write(*,*)"Which algorithm do you want to use:"
write(*,*)"1-SPARSE"
write(*,*)"2-FORTRAN"
write(*,*)"3-DGEMM"
read(*,*)option1
...
elseif (option1 == 2 .or. option1 == 3) then
...
write(*,*)"NOT A VALID OPTION, RETRY"
goto 111
endif
